...
const menu = [
  ...
  { name: "ข้อมูลอุปกรณ์", icon: <ComputerIcon />, path: "/device",roleLevel:3 },
];
        ...
        <Box sx={{ display: "flex" }}>
          ...
          <AppBar position="absolute" open={open}>
            <Toolbar
              ...
              <Typography component="h1" variant="h6" color="inherit" noWrap sx={{ flexGrow: 1 }}> แจ้งซ่อมอุปกรณ์คอมพิวเตอร์ </Typography>
              <Button color="inherit" onClick={signout}> ออกจากระบบ </Button>
            </Toolbar>
          </AppBar>
